...
```
##Statystyka opisowa - wizualizacje
...
```
##Wykres kołowy - Jaki procent nieruchomości o powierzchni z danego przedziału posiada posiada wskazaną liczbę łazienek.
...
```
##Korelogram przedstawiający korelacje pomiędzy zmiennymi dla domów z dwoma i sześcioma sypialniami z podziałem na dwie grupy - czy znajdują się przy głównej ulicy (1), czy nie (0).
```{r}
grouped_ggcorrmat(
