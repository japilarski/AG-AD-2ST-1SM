...
Korelogram przedstawiający korelację pomiędzy zmiennymi dla domów z dwoma i sześcioma sypialniami z podziałem na dwie grupy - czy znajdują się przy głównej ulicy (1), czy nie (0). ⁠Poniższy wykres pozwala nam przeanalizować wpływ ilości sypialni na cenę. Najdroższe mieszkanie posiadają 3 i 4 sypialnie. Dodatkowo duży wpływ ma preferowana lokalizacja.
